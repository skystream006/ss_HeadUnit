package com.skystream.ssheadunit.contract
...
object HeadUnit {
    const val packageName = "com.skystream.ssheadunit"
}
...
/**
 * Broadcast sent when ssHeadUnit receives navigation updates from Android Auto
