...
object DialogUtils {
    ...
    fun showTextInputDialogWithMessage(
        ...
        val dialog = MaterialAlertDialogBuilder(context, com.skystream.ssheadunit.R.style.DarkAlertDialog)
            .setTitle(titleResId)
            .setView(container)
            ...
            .setNeutralButton(com.skystream.ssheadunit.R.string.reset) { _, _ ->
                onResult("")
            }
