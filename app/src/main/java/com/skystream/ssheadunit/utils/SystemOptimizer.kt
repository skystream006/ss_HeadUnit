...
class SystemOptimizer(private val context: Context) {
    ...
    fun checkH265HardwareSupport(): Boolean {
        return com.skystream.ssheadunit.decoder.VideoDecoder.isHevcSupported()
    }
    ...
    companion object {
        ...
        fun recommendedResolution(realWidthPx: Int, realHeightPx: Int): Settings.Resolution =
            panelCeiling(realWidthPx, realHeightPx, com.skystream.ssheadunit.decoder.VideoDecoder.isHevcSupported())
    }
}
