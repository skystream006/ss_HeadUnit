...
import com.skystream.ssheadunit.app.UsbAttachedActivity
...
class Settings(private val context: Context) {
    ...
    var vehicleDisplayName: String
        get() = prefs.getString("vehicle-display-name", "ssHeadUnit")!!
    ...
    var geofenceLocations: List<com.skystream.ssheadunit.location.GeofenceLocation>
        get() = com.skystream.ssheadunit.location.GeofenceLocation.listFromJson(
            prefs.getString("geofence-locations", "[]")
        )
        set(value) {
            val json = com.skystream.ssheadunit.location.GeofenceLocation.listToJson(value)
