...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ContextCompat.registerReceiver(
            this, finishReceiver,
            android.content.IntentFilter("com.skystream.ssheadunit.ACTION_FINISH_ACTIVITIES"),
    ...
    private fun handleLaunchIntent(intent: Intent?) {
        ...
        if (intentAction == "com.skystream.ssheadunit.ACTION_EXIT") {
    ...
    companion object {
        ...
        const val ACTION_RECREATE_MAIN = "com.skystream.ssheadunit.ACTION_RECREATE_MAIN"
    }
}
