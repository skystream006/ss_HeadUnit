...
class KeymapFragment : Fragment(), MainActivity.KeyListener {
    ...
    private val keyCodeReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            if (intent.action == "com.skystream.ssheadunit.DEBUG_KEY") {
                val action = (intent.getStringExtra("action") ?: "unknown").replace("com.skystream.ssheadunit.", "")
    ...
    override fun onResume() {
        ...
        filter.addAction("com.skystream.ssheadunit.DEBUG_KEY")
