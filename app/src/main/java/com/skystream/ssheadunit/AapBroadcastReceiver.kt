...
import com.skystream.ssheadunit.aap.protocol.messages.LocationUpdateEvent
...
import com.skystream.ssheadunit.contract.MediaKeyIntent
...
class AapBroadcastReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == LocationUpdateIntent.action) {
            ...
            com.skystream.ssheadunit.location.LocationHolder.update(location)
