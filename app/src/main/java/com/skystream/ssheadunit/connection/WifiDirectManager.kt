...
import com.skystream.ssheadunit.aap.P2pChannelPolicy
...
class WifiDirectManager(private val context: Context) : WifiP2pManager.ConnectionInfoListener, WifiP2pManager.GroupInfoListener {
            ...
            when (intent.action) {
                WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION -> {
                    ...
                    if (state == WifiP2pManager.WIFI_P2P_STATE_ENABLED) {
                        val appSettings = com.skystream.ssheadunit.App.provide(context).settings
                        val commManager = com.skystream.ssheadunit.App.provide(context).commManager
                        val isConnectingOrConnected = commManager.isConnected ||
                            commManager.connectionState.value is com.skystream.ssheadunit.connection.CommManager.ConnectionState.Connecting
                ...
                WifiP2pManager.WIFI_P2P_THIS_DEVICE_CHANGED_ACTION -> {
                    ...
                    device?.let {
                        if (com.skystream.ssheadunit.App.provide(context).settings.wifiConnectionMode != 3) {
    ...
    private fun triggerWifiSettings() {
        ...
        handler.postDelayed({
            try {
                val intent = Intent(context, com.skystream.ssheadunit.main.MainActivity::class.java).apply {
    ...
    private fun isNativeAaMode(): Boolean {
        return com.skystream.ssheadunit.App.provide(context).settings.wifiConnectionMode == 3
    }
