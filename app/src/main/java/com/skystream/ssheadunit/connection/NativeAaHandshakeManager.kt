package com.skystream.ssheadunit.connection
...
import com.skystream.ssheadunit.aap.NativeCredentialsPolicy
import com.skystream.ssheadunit.aap.NativeHandoffPolicy
import com.skystream.ssheadunit.aap.NativeTransport
import com.skystream.ssheadunit.aap.UnusableBssidAction
import com.skystream.ssheadunit.aap.WppAction
import com.skystream.ssheadunit.aap.WppEvent
import com.skystream.ssheadunit.aap.WppFraming
import com.skystream.ssheadunit.aap.WppHandshakeSession
import com.skystream.ssheadunit.aap.WppMessageType
import com.skystream.ssheadunit.aap.WppStage
import com.skystream.ssheadunit.utils.BluetoothHelper
import com.skystream.ssheadunit.aap.protocol.proto.Wireless
...
class NativeAaHandshakeManager(
    ...
    companion object {
        ...
        fun externalBtOverridden(context: Context): Boolean =
            com.skystream.ssheadunit.App.provide(context)
    ...
    private val settings = com.skystream.ssheadunit.App.provide(context).settings
    private val commManager = com.skystream.ssheadunit.App.provide(context).commManager
    ...
    private suspend fun handleHandshake(socket: BluetoothSocket, localRadio: String? = null) = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            if (!macs.contains(device.address)) {
                ...
                com.skystream.ssheadunit.utils.Settings.syncAutoStartBtMacsToDeviceStorage(context, newMacs)
            }
     ...
     * behind [com.skystream.ssheadunit.utils.Settings.nativeWifiVersionExchange].
     *
