...
class RemoteControlReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val debugIntent = Intent("com.skystream.ssheadunit.DEBUG_KEY").apply {
        ...
        if (Intent.ACTION_MEDIA_BUTTON == action) {
            ...
            event?.let {
                ...
                val keyIntent = Intent(com.skystream.ssheadunit.contract.KeyIntent.action).apply {
                    putExtra(com.skystream.ssheadunit.contract.KeyIntent.extraEvent, it)
                    setPackage(context.packageName)
                }
