 ...
 * [com.skystream.ssheadunit.connection.NativeAaHandshakeManager] and
 * [com.skystream.ssheadunit.connection.WifiDirectManager] share one definition instead of
 * re-deriving it.
 */
object NativeHandoffPolicy {
     ...
     *  ([com.skystream.ssheadunit.aap.WppAction.ExtendSettle]) have extended it. Without a cap,
