...
object SoftApCredentialsPolicy {
    ...
    /**
     * @param manualSsid [com.skystream.ssheadunit.utils.Settings.hotspotSsid] — the user's
     *   override, and the one thing that makes this route work on a device that hides its own
     *   configuration
     * @param manualPassphrase [com.skystream.ssheadunit.utils.Settings.hotspotPassword]
