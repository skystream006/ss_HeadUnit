...
object UserExitHotspotPolicy {
    ...
    /**
     * @param mode [com.skystream.ssheadunit.utils.Settings.wifiConnectionMode]
     * @param strategy [com.skystream.ssheadunit.utils.Settings.helperConnectionStrategy]
     * @param transport applies to [mode] 3 only
     * @param autoEnableHotspot [com.skystream.ssheadunit.utils.Settings.autoEnableHotspot] — the
