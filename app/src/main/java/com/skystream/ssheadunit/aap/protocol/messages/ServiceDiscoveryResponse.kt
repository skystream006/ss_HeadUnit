...
import com.skystream.ssheadunit.aap.protocol.proto.Control
    ...
    companion object {
        private fun makeProto(context: Context): Message {
                    ...
                    val explicitSoftwareHevc =
                        settings.videoCodec == VideoDecoder.CodecType.H265.settingsValue &&
                                ...
                                when (settings.softwareVideoDecoder) {
                                    com.skystream.ssheadunit.utils.Settings.SoftwareVideoDecoder.BUNDLED_FFMPEG ->
                                        com.skystream.ssheadunit.decoder.VideoDecoder.isBundledHevcDecoderAvailable()
                                    com.skystream.ssheadunit.utils.Settings.SoftwareVideoDecoder.DEVICE_MEDIACODEC ->
                                        com.skystream.ssheadunit.decoder.VideoDecoder.isHevcDecoderAvailable(includeSoftware = true)
                                }
                    val hevcAvailableForUserChoice =
                        com.skystream.ssheadunit.decoder.VideoDecoder.isHevcSupported() || explicitSoftwareHevc
                    val hevcAvailableForHighResolution =
                        com.skystream.ssheadunit.decoder.VideoDecoder.isHevcReliable() || explicitSoftwareHevc
                    ...
                    val codecToRequest = when (settings.videoCodec) {
                        ...
                        "Auto" -> {
                            ...
                            if (negotiatedResolution == Control.Service.MediaSinkService.VideoConfiguration.VideoCodecResolutionType._3840x2160 &&
                                com.skystream.ssheadunit.decoder.VideoDecoder.isHevcReliable()) {
                                Media.MediaCodecType.MEDIA_CODEC_VIDEO_H265
                            } else {
                                Media.MediaCodecType.MEDIA_CODEC_VIDEO_H264_BP
                            }
            ...
            return Control.ServiceDiscoveryResponse.newBuilder().apply {
                ...
                setHeadunitInfo(com.skystream.ssheadunit.aap.protocol.proto.Common.HeadUnitInfo.newBuilder().apply {
